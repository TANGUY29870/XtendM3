...
public class AddEcoConCod extends ExtendM3Transaction {
  ...
  public AddEcoConCod(MIAPI mi, DatabaseAPI database , ProgramAPI program, MICallerAPI miCaller, UtilityAPI utility, LoggerAPI logger) {
    this.mi = mi;
  ...
  private boolean createEnreg(String ecrg, String csor, String ecoc, String tx40, String tx15, String crid, String ceid, String flgt) {
    ...
    if (!query.read(container)) {
      ...
      container.set("CECHNO", 1);                                             // Incrément de modification initialisé à 1 
